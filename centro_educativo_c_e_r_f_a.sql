...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2026 a las 15:49:08
...
--
-- Base de datos: `centro_educativo_c.e.r.f.a`
--
...
INSERT INTO `estudiantes` (`id_estudiante`, `nombre`, `apellido`, `fecha_nacimiento`, `id_grado`, `id_tutor`) VALUES
(1, 'Felipe', 'Pérez', '2019-05-20', 1, 1),
(2, 'Gerson', 'Martínez', '2018-03-12', 2, 2),
(3, 'Allison', 'Guillén', '2017-09-25', 3, 3),
(4, 'Emerson', 'Cornejo', '2017-07-04', 4, 4),
(5, 'Fátima', 'Ortiz', '2016-11-18', 5, 5),
(6, 'Kevin', 'Santana', '2016-01-30', 6, 6),
(7, 'Josué', 'Chicas', '2015-08-14', 7, 7),
(8, 'Milena', 'Mayorga', '2015-04-02', 8, 8),
(9, 'Nelson', 'Bonilla', '2014-10-10', 9, 9),
(10, 'Daniela', 'Arévalo', '2014-12-05', 10, 10),
(11, 'Bryan', 'Tamacas', '2013-06-15', 11, 11),
(12, 'Mélida', 'Anaya', '2013-02-28', 12, 12),
(13, 'Rudy', 'Clavel', '2012-07-22', 13, 13),
(14, 'Tatiana', 'Aparicio', '2012-05-14', 14, 14),
(15, 'Marvin', 'Monterroza', '2012-11-03', 15, 15),
(16, 'Gaby', 'Umaña', '2011-12-21', 16, 16),
(17, 'Érick', 'Cabalzeta', '2011-04-19', 17, 17),
(18, 'Heidy', 'Mayer', '2011-01-11', 18, 18),
(19, 'Jairo', 'Henríquez', '2010-08-09', 19, 19),
(20, 'Karla', 'Torres', '2010-10-31', 20, 20),
(21, 'Alexis', 'Renderos', '2010-02-14', 21, 21);
...
ALTER TABLE `estudiantes`
  ...
  ADD CONSTRAINT `estudiantes_ibfk_2` FOREIGN KEY (`id_tutor`) REFERENCES `tutores` (`id_tutor`) ON DELETE SET NULL;
